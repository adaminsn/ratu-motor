...
import { Bike, ShieldCheck, Award, Clock, Users, Sparkles, Building2, Target, Heart, ChevronRight } from 'lucide-react'
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="text-center mb-12">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold text-[#1a2f4f]">
          Kenali <span className="text-[#f97316]">Ratu Motor</span> Lebih Dekat
        </h1>
      ...
      <div id="stats-section" className="grid grid-cols-2 sm:grid-cols-4 gap-4 bg-white rounded-3xl shadow-sm p-6 mb-12 border border-gray-100">
        {[
          ...
          <div key={stat.label} className="text-center p-4 rounded-xl hover:bg-gray-50 transition-all duration-300">
            <p className="text-3xl font-bold text-[#f97316]">{stat.value}{stat.suffix}</p>
        ...
        <div className="bg-gradient-to-br from-white to-gray-50 rounded-3xl p-8 shadow-sm border border-gray-100">
          ...
          <ul className="space-y-3 text-gray-600">
            <li className="flex items-start gap-3">
              <ChevronRight size={18} className="text-[#f97316] mt-0.5 flex-shrink-0" />
      ...
      <div className="mb-12">
        <h2 className="text-2xl font-bold text-[#1a2f4f] text-center mb-8">
          Nilai <span className="text-[#f97316]">Kami</span>
        </h2>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {values.map(({ icon: Icon, label, desc }) => (
            <div key={label} className="bg-white rounded-2xl p-6 text-center shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-gray-100">
      ...
      <div className="bg-gradient-to-r from-[#1a2f4f] to-[#0f1f33] rounded-3xl p-8 text-center text-white">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <Link
            to="/katalog"
            className="px-8 py-3 bg-[#f97316] hover:bg-orange-600 text-white font-semibold rounded-xl shadow-lg shadow-orange-500/20 transition-all duration-300 hover:shadow-orange-500/40 hover:-translate-y-0.5"
          >
            Lihat Katalog
          </Link>
          <Link
